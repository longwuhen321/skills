"""Verify formula escapes, display blocks, Markdown tables, and local images."""
import io
import re
import sys
...
# Formula escapes and display delimiters
...
# Non-code, non-math Markdown semantics
